package com.java.tienda.configuration;
...
public class Conexion {
	...
	static String bd = "tienda_curso_serbatic?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
